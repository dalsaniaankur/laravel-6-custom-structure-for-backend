...
namespace App\Http\Controllers\School\BackendLog;
...
class IndexController extends Controller
{
    ...
    public function index(Request $request){
        ...
        $roleDropDownList = $this->rolesObj->getDropDown('All');

        return view('school.backend_log.index',compact('sortedBy', 'sortedOrder', 'recordStart','users','paging','totalRecordCount','roleDropDownList','name','email','roleId'));
    }
