...
namespace App\Http\Controllers\School\EmailTemplate;
...
class IndexController extends Controller
{
    ...
    public function index( Request $request )
    {
        ...
        return view( 'school.emailtemplate.index', compact( 'sortedBy', 'recordStart','sortedOrder',  'paging', 'totalRecordCount', 'emailTemplates','templateName') );
    }
	...
	public function emailDetails(Request $request, $emailtemplateId) {
		...
		return view('school.emailtemplate.details',compact('emailtemplate'));
	}
