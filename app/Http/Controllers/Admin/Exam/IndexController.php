...
class IndexController extends Controller
{
    ...
    public function index( Request $request, $schoolId = 0 )
    {
        ...
        $schoolId = ! empty( $data['school_id'] ) ? $data['school_id'] : 0;
        ...
        return view( 'admin.exam.index', compact( 'examName','schoolId', 'examStartDate', 'examEndDate','sortedBy', 'sortedOrder', 'recordStart', 'exams', 'paging', 'totalRecordCount', 'schoolDropDownList' ) );
    }
    ...
    {
        $data = $request->all();
        $data['created_user_id'] = Auth::guard('admin')->getUser()->user_id;
