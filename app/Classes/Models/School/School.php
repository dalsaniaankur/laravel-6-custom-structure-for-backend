...
namespace App\Classes\Models\School;
...
class School extends AuthBaseModel
{
    ...
    public function sendPasswordResetNotification( $token )
    {
        ...
        $toName = $this->name;
        $toEmail = $this->email;
        $htmlContent = \View::make('backend.auth.emails.forgot_password',['token' => $token,'subject' => $subject,'name' => $toName,'roleBaseRoute' => 'school'])->render();
