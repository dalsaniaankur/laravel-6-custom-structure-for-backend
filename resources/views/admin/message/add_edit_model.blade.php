        ...
        <div class="modal-content">
            ...
            <div class="modal-body modal_success">
                ...
                <div class="mb-5">
                    ...
                    <span class="is-school-name">({{ ucfirst(Auth::guard('admin')->user()->name) }})</span>
                </div>
                <div class="col-lg-12 col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12">
                            ...
                            {!! Form::select('role_id', ['' => 'Select user type','2' => 'School','3' => 'Teacher','4' => 'Student','5' => 'Parent','6' => 'PTA Member'], old('role_id'), ['class' => 'form-control mb-4 role_id', 'required' => '','onchange' => "getUserDropDownForNotification()"]) !!}
                        </div>

                        <div class="col-lg-12 col-md-12 multiselect_checkbox">
                            {!! Form::label('receiver_id', 'Receiver') !!}
                            {!! Form::select('receiver_id[]', [], old('receiver_id'), ['multiple'=> '', 'class' => 'form-control mb-4 receiver_id', 'required' => '']) !!}
                        </div>
