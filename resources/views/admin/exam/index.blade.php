...
@section('content')
            ...
            <div class="page-wrap bx-shadow mt-5 mb-5">
                <div class="row user-dt-wrap">
                    <div class="col-lg-12 col-md-12 pb-5">
                        <h1 class="admin_bigheading mb-5 inlinebtn">Exams
                        ...
                        {!! Form::open(['method' => 'GET','name'=>'admin-exam-search', 'id' =>'admin_exam_search_form', 'class'=>'top-search-options form-row pb-4','route' => ['admin.exams']]) !!}
                        ...
                        <div class="col-md-3 col-lg-2">
                            <a href="{{ url('admin/exams?school_id='.$schoolId)}}">
	...
	@include('admin.exam.edit_model')
@endsection
@section('javascript')
    <script>
        var form = 'form#admin_exam_search_form';
		var formAddEditForm = 'form#add_edit_exam_model_form';
        window.addEditUrl = "{{ URL::to('admin/exam/ajax_save') }}";
        window.getDataForEditUrl = "{{ URL::to('admin/exam/get_data') }}";
        ...
        function openAddModal(modelSelector) {
            ...
            schoolIdElement.prop('disabled', false);
            ...
            jQuery.ajax({
                ...
                success: function (response) {
                    if (response.success == true) {
                        ...
                        schoolIdElement.prop('disabled', true);
                        hideLoader();
                        openModal(modelSelector);
                    } else {
                        hideLoader();
