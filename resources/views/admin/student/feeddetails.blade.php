...
@section('content')
		...
		<div class="container n_success">
            ...
            <div class="row user-dt-wrap">
                <div class="col-lg-12 col-md-12 pb-5">
                 ...
                 {!! Form::open(['method' => 'GET','name'=>'student-feed-search', 'id' =>'student_feed_search_form', 'class'=>'top-search-options form-row pb-4 border_bottom','url' => url('admin/student/feed/').'/'.Common::getEncryptId($student->user_id)]) !!}
                    <div class="col-md-3 col-lg-2">
                        <a href="{{ url('admin/student/feed/').'/'.Common::getEncryptId($student->user_id) }}">
									...
									<div class="Aca_recentscore brd-after">
										...
										<div class="feedbtns">
											...
											{!! Form::open(array(
                                                        ...
                                                        'route' => ['admin.student.feed.delete'])) !!}
	...
	@include('admin.student.add_edit_feedmodel')
@endsection
@section('javascript')
    <script>
        ...
        window.addEditUrl = "{{ URL::to('admin/student/feed/ajax_save') }}";
        window.getDataForEditUrl = "{{ URL::to('admin/student/feed/get_data') }}";
        ...
        attendanceElement = $(formAddEditForm + " #attendance");
