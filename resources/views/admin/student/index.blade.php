...
@section('content')
            ...
            <div class="page-wrap bx-shadow mt-5 mb-5">
                <div class="row user-dt-wrap">
                    <div class="col-lg-12 col-md-12 pb-5">
                        <h1 class="admin_bigheading mb-5 inlinebtn">Students
                        ...
                        {!! Form::open(['method' => 'GET','name'=>'admin-student-search', 'id' =>'admin_student_search_form', 'class'=>'top-search-options form-row pb-4','route' => ['admin.students']]) !!}
                        ...
                        <div class="col-md-3 col-lg-2">
                            <a href="{{ url('admin/students?school_id='.$schoolId) }}">
                        ...
                        <div class="col-md-4 col-lg-2">
                            {!! Form::select('grade_id', $gradeDropDownForSearch, $gradeId, ['class' => 'form-control mb-3']) !!}
                        </div>
                                    ...
                                    @foreach($students as $studentKey => $student)
                                        <tr>
                                            ...
                                            <td class="action_div">
                                                ...
                                                <a href="{{ url('admin/student/profile')}}/{{ Common::getEncryptId($student->user_id) }}"
                                                ...
                                                {!! Form::hidden('school_id',$student->school_id ) !!}
    ...
    @include('admin.student.add_edit_model')
@endsection
@section('javascript')
    <script>
        ...
        window.addEditStudentUrl = "{{ URL::to('admin/student/save_ajax') }}";
        window.getStudentDataForEditUrl = "{{ URL::to('admin/student/get_data') }}";
