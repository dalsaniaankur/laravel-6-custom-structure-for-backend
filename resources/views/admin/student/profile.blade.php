    ...
    <div class="main_section">
        <div class="container n_success">
            <div class="details_tabs mt-3">
                ...
                <a href="{{ url('admin/student/academics')}}/{{ Common::getEncryptId($student->user_id) }}">Academics</a>
                <a href="{{ url('admin/student/feed')}}/{{ Common::getEncryptId($student->user_id) }}">feed</a>
            </div>
            <div class="page-wrap bx-shadow mt-3 mb-5">
                <div class="row user-dt-wrap">
                    <div class="col-lg-12 col-md-12 pb-5 school_details profile_details">
                        <h1 class="admin_bigheading mb-5 w_100">Profile: {{ $student->name }}</h1>
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-9 user-dt">
                                        <p><span>{{ $student->name }}</span>
                                            <span><b>Grade:</b></span>{{ $student->grade->grade_name }}
                                            <br/><br/>
                                            <span><b>Gender:</b></span>{{ $student->gender == 1 ? "Male" : "Female" }}
                                        </p>
                            ...
                            'route' => ['admin.student.ban_reactive'])) !!}
                                    ...
                                    {!! Form::open(array('method' => 'DELETE',
                                                        ...
                                                        'route' => ['admin.student.delete'], 'id'=>'removestudent')) !!}
                                    {!! Form::hidden('id', $student->user_id, array('id' => 'delete_user_id')) !!}
                                    {!! Form::hidden('school_id', $student->school_id, array('id' => 'delete_school_id')) !!}
                            ...
                            <div class="col-lg-6 col-md-6 pb-5 px-md-5 label_blue">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        {!! Form::open(['method' => 'POST','enctype' => 'multipart/form-data','name'=>'student-change-password-form', 'id' =>'student_change_password_form', 'class'=>'mb-5','data-parsley-validate','route' => ['admin.student.change_password']]) !!}
                                                ...
                                                @foreach($studentTeacher as $studentTeacherKey => $studentTeacher )
                                                    <div class="row mb-3">
                                                        <div class="float-left col-lg-6">
                                                            {{ $studentTeacher->name }}<br>
                                                            {{ Common::getPhoneFormat( $studentTeacher->phone ) }}<br>
                    ...
                    <div class="col-lg-12 col-md-12 pb-5 px-md-5 editspace">
                        <div class="row">
                            ...
                            {!! Form::open(['method' => 'POST','enctype' => 'multipart/form-data','name'=>'student-edit-profile-form', 'id' =>'student_edit_profile_form', 'class'=>'w-100','data-parsley-validate','route' => ['admin.student.profile.save']]) !!}
                    ...
                    <div class="col-lg-12 col-md-12 pb-0 pt-5 pb0 Profilecategory">
                        <div class="row">
                            <div class="col-md-6 col-lg-6 pb-5 px-md-5 profile_border">
                                ...
                                {!! Form::open(['method' => 'POST','enctype' => 'multipart/form-data','name'=>'student-allergy-form', 'id' =>'student_allergy_form', 'class'=>'w-100','data-parsley-validate','route' => ['admin.student.allergy.save']]) !!}
                            ...
                            <div class="col-md-6 col-lg-6 pb-5 px-md-5">
                                ...
                                {!! Form::open(['method' => 'POST','enctype' => 'multipart/form-data','name'=>'student-club-form', 'id' =>'student_club_form', 'class'=>'w-100','data-parsley-validate','route' => ['admin.student.club.save']]) !!}
                    ...
                    @if((!empty($allergies) && count($allergies) > 0) || (!empty($clubs) && count($clubs) > 0))
                        <div class="col-lg-12 col-md-12 pb-0 pt-0 pb0 pt0 Profilecategory">
                            <div class="row">
                                <div class="col-md-12 col-lg-6 pb-0 pb0 px-md-5">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="EMT_icon">
                                                            {!! Form::open(array(
                                                                ...
                                                                'route' => ['admin.student.allergy.delete'])) !!}
                                ...
                                <div class="col-md-12 col-lg-6 pb-0 px-md-5">
                                    <div class="table-responsive EMT_table">
                                        <table class="table sorting data-table">
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="EMT_icon">
                                                            {!! Form::open(array(
                                                                ...
                                                                'route' => ['admin.student.club.delete'])) !!}
