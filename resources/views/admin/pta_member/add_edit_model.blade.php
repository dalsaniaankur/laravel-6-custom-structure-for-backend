<div class="modal add-edit-pta_member-model" id="pta_member_model">
    <div class="modal-dialog">

        {!! Form::open(['method' => 'POST','enctype' => 'multipart/form-data','name'=>'add-edit-pta-member-model-form', 'id' =>'add_edit_pta_member_model_form', 'class'=>'add-edit-pta_member-form-model','data-parsley-validate']) !!}
        ...
        <div class="modal-content">
            ...
            <div class="modal-body modal_success">
                @if(!empty($schoolName))
                    <h4 class="modal-title mb-0" >Add PTA member</h4>
                    <div class="mb-5">
                ...
                <div class="col-lg-12 col-lg-12">
                    <div class="row">
                        ...
                        {!! Form::hidden('user_id', 0, array('id' => 'add_edit_pta_member_model_id')) !!}
                        ...
                        @else
                            <div class="col-lg-6 col-md-6">
                                ...
                                {!! Form::select('school_id', $schoolDropDownList, $schoolId , ['class' => 'form-control mb-4', 'required' => '']) !!}
                                @include('backend.partials.message.field',['field_name' => 'school_id'])
                            </div>
                        @endif
