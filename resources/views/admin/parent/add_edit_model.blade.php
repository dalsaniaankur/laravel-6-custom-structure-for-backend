    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body modal_success">
                ...
                @else
                    <h4 class="modal-title mb-5" >Add parent</h4>
                @endif
                ...
                <div class="col-lg-12 col-lg-12">
                    <div class="row">
						...
						<div class="col-lg-6 col-md-6">
							...
							{!! Form::select('school_id', $schoolDropDownList, $schoolId, ['onchange' => "getStudentMultipleDropDown(this,'#student_id')",'class' => 'form-control mb-4', 'required' => '']) !!}
						</div>
                        @endif
