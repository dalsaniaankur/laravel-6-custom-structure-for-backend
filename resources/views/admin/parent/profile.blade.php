                ...
                <div class="row user-dt-wrap">
                    ...
                    <div class="col-lg-12 col-md-12 pb-5 school_details">
                        ...
                        <div class="row">
                            ...
                            'route' => ['admin.parent.ban_reactive'])) !!}
                                    ...
                                    {!! Form::open(array('method' => 'DELETE',
                                                        ...
                                                        'route' => ['admin.parent.delete'], 'id'=>'removeparent')) !!}
                                    {!! Form::hidden('id', $parent->user_id, array('id' => 'delete_user_id')) !!}
                                    {!! Form::hidden('school_id', $parent->school_id, array('id' => 'delete_school_id')) !!}
                            ...
                            <div class="col-lg-6 col-md-6 pb-5 px-md-5 label_blue pb0">
                                ...
                                <div class="row after_bottom_border">
                                    <div class="col-lg-12 col-md-12">
                                        {!! Form::open(['method' => 'POST','enctype' => 'multipart/form-data','name'=>'admin-change-password-form', 'id' =>'admin_change_password_form', 'class'=>'login-form','data-parsley-validate','route' => ['admin.parent.change_password']]) !!}
                            ...
                            <div class="col-lg-12 pb-5 px-md-5 mt-5 label_blue">
                                ...
                                {!! Form::open(['method' => 'POST','enctype' => 'multipart/form-data','name'=>'admin-edit-profile-form', 'id' =>'admin_edit_profile_form', 'class'=>'login-form','data-parsley-validate','route' => ['admin.parent.profile.save']]) !!}
                                ...
                                <div class="form-edit-profile multiselect_checkbox">
                                    ...
                                    --}}
                                    <a href="{{ url('admin/students?school_id='.$parent->school_id.'&parent_id='.$parent->user_id) }}" class="viewbtn">View student</a>
                                </div>
