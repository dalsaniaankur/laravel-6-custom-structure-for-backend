            ...
            <div class="page-wrap bx-shadow mt-5 mb-5">
                <div class="row user-dt-wrap">
                    <div class="col-lg-12 col-md-12 pb-5">
                        <h1 class="admin_bigheading mb-5 inlinebtn">Parents
                        ...
                        {!! Form::open(['method' => 'GET','name'=>'admin-parent-search', 'id' =>'admin_parent_search_form', 'class'=>'top-search-options form-row pb-4','route' => ['admin.parents']]) !!}
                        ...
                        <div class="col-md-3 col-lg-2">
                            <a href="{{ url('admin/parents?school_id='.$schoolId) }}">
                                    ...
                                    @foreach($parents as $parentKey => $parent)
                                        <tr>
                                            ...
                                            <td class="action_div">
                                                ...
                                                <a href="{{ url('admin/parent/profile/')}}/{{ Common::getEncryptId($parent->user_id) }}"
                                                   class="viewbtn">view</a>
                                                {!! Form::open(array(
                                                        'method' => 'DELETE',
                                                         'onsubmit' => "return confirm('".trans("admin.qa_are_you_sure_delete")." parent?');",
                                                        'route' => ['admin.parent.delete'])) !!}
                                                {!! Form::hidden('id',$parent->user_id ) !!}
                                                {!! Form::hidden('school_id',$parent->school_id ) !!}
...
@include('admin.parent.add_edit_model')
@endsection
@section('javascript')
    <script>
        ...
        window.addEditParentUrl = "{{ URL::to('admin/parent/save_ajax') }}";
        ...
        schoolIdElement = $(addEditParentForm + " #school_id");
        ...
        function resetParentForm() {
            ...
            //getStudentDropDown(selfEle = '#school_id', classEle = '#student_id')
        }
