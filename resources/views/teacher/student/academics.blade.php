...
@section('content')
            ...
            <div class="page-wrap bx-shadow mt-3 mb-5">
                <div class="row user-dt-wrap">
                    <div class="col-lg-12 col-md-12 pb-5 Academic_details pb0">
                        ...
                        {!! Form::open(['method' => 'POST','enctype' => 'multipart/form-data','name'=>'admin-student-bio-create', 'id' =>'admin_student_bio_create_form', 'class'=>'teacher-create-form','data-parsley-validate','route' => ['teacher.student.bio.update']]) !!}
                    ...
                    <div class="col-lg-12 col-md-12 pb-5">
                        ...
                        {!! Form::open(['method' => 'GET','name'=>'student-academics-search', 'id' =>'student_academics_search_form', 'class'=>'top-search-options form-row pb-4 border_bottom','url' => url('teacher/student/academics/').'/'.Common::getEncryptId($student->user_id)]) !!}
                        <div class="col-md-3 col-lg-2">
                            <a href="{{ url('teacher/student/academics/').'/'.Common::getEncryptId($student->user_id) }}">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="Aca_recentscore brd-after">
                                            ...
                                            {!! Form::open(array(
                                                        ...
                                                        'route' => ['teacher.student.exam_result.delete'])) !!}
    ...
    @include('teacher.student.add_edit_academicsmodel')
@endsection
@section('javascript')
    <script>
        var formAddEditForm = 'form#add_edit_academic_model_form';
        window.addEditUrl = "{{ URL::to('teacher/student/academic/ajax_save') }}";
        window.getDataForEditUrl = "{{ URL::to('teacher/student/academic/get_data') }}";
        window.addDeleteUrl = "{{ URL::to('teacher/student/academic/delete') }}";
