    ...
    <div class="main_section">
        ...
        <div class="container n_success">
            <div class="details_tabs mt-3">
                ...
                <a href="{{ url('teacher/student/feed')}}/{{ Common::getEncryptId($student->user_id) }}">feed</a>
            </div>
                ...
                <div class="row user-dt-wrap">
                        ...
                        <div class="row">
                                        ...
                                        @if($studentParents->count() > 0)
                                            <p class="mb-5">
                                                ...
                                                @foreach($studentParents as $studentParentKey => $studentParent )
                                                    ...
                                                    {{ Common::getPhoneFormat( $studentParent->parent->phone ) }}<br>
                                                    @endif
                            ...
                            'route' => ['teacher.student.ban_reactive'])) !!}
                                    ...
                                    {!! Form::open(array('method' => 'DELETE',
                                                        ...
                                                        'route' => ['teacher.student.delete'], 'id'=>'removestudent')) !!}
                            ...
                            <div class="col-lg-6 col-md-6 pb-5 px-md-5 label_blue">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        {!! Form::open(['method' => 'POST','enctype' => 'multipart/form-data','name'=>'student-change-password-form', 'id' =>'student_change_password_form', 'class'=>'mb-5','data-parsley-validate','route' => ['teacher.student.change_password']]) !!}
                    ...
                    <div class="col-lg-12 col-md-12 pb-5 px-md-5 editspace">
                        <div class="row">
                            ...
                            {!! Form::open(['method' => 'POST','enctype' => 'multipart/form-data','name'=>'student-edit-profile-form', 'id' =>'student_edit_profile_form', 'class'=>'w-100','data-parsley-validate','route' => ['teacher.student.profile.save']]) !!}
                    ...
                    <div class="col-lg-12 col-md-12 pb-0 pt-5 pb0 Profilecategory">
                        <div class="row">
                            <div class="col-md-6 col-lg-6 pb-5 px-md-5 profile_border">
                                ...
                                {!! Form::open(['method' => 'POST','enctype' => 'multipart/form-data','name'=>'student-allergy-form', 'id' =>'student_allergy_form', 'class'=>'w-100','data-parsley-validate','route' => ['teacher.student.allergy.save']]) !!}
                            ...
                            <div class="col-md-6 col-lg-6 pb-5 px-md-5">
                                ...
                                {!! Form::open(['method' => 'POST','enctype' => 'multipart/form-data','name'=>'student-club-form', 'id' =>'student_club_form', 'class'=>'w-100','data-parsley-validate','route' => ['teacher.student.club.save']]) !!}
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="EMT_icon">
                                                            {!! Form::open(array(
                                                                ...
                                                                'route' => ['teacher.student.allergy.delete'])) !!}
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="EMT_icon">
                                                            {!! Form::open(array(
                                                                ...
                                                                'route' => ['teacher.student.club.delete'])) !!}
