...
@section('title', 'Email Template | '.trans('admin.backend_title'))
@section('content')
					...
					<div class="col-lg-12 col-md-12 pb-5">
						...
						<div class="col-lg-12 pb-5 px-md-5 mt-5">
							<div class="col-lg-8 col-md-8">
								...
								{!! Form::open(['method' => 'POST','enctype' => 'multipart/form-data','name'=>'admin-email-template-form', 'id' =>'admin_email_template_form', 'data-parsley-validate','route' => ['school.emailtemplate.save']]) !!}
								...
								<div class="form-edit-fields">
									...
									@include('backend.partials.message.field',['field_name' => 'subject'])
								</div>
