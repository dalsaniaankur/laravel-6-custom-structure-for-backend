...
@section('title', 'Email Templates | '.trans('admin.backend_title'))
@section('content')
            ...
            <div class="page-wrap bx-shadow mt-5 mb-5">
                <div class="row user-dt-wrap">
                    <div class="col-lg-12 col-md-12 pb-5">
                        ...
                        {!! Form::open(['method' => 'GET','name'=>'admin-email-template-search', 'id' =>'admin_email_template_search_form', 'class'=>'top-search-options form-row pb-4','route' => ['school.email_templates']]) !!}
                        {!! Form::hidden('sorted_by', $sortedBy, array('id' => 'sortedBy')) !!}
                        {!! Form::hidden('sorted_order', $sortedOrder, array('id' => 'sortedOrder')) !!}

                        <div class="col-md-3 col-lg-2">
                            <a href="{{ url('school/email-templates') }}">
                                ...
                                @if(!empty($emailTemplates) && count($emailTemplates) > 0)
                                    @foreach($emailTemplates as $emailTemplateKey => $emailTemplate)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('school/email-templates/details/')}}/{{ Common::getEncryptId($emailTemplate->email_template_id) }}"
