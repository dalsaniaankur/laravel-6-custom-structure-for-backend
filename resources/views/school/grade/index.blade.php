                ...
                <div class="row user-dt-wrap">
                    <div class="col-lg-12 col-md-12">
                        <div class="page-heading">
                            <h1 class="admin_bigheading">Grades ({{ $totalRecordCount }})</h1>
                        ...
                        @include('school.grade.partials.table_with_sorting')
                    </div>
                </div>
            </div>
        </div>
    </div>
    @include('school.grade.add_edit_model')
@endsection
@section('javascript')
    <script>
        /* Save Ajax Call */
        jQuery(window._add_edit_model_element + ' form').submit(function (event) {
            ...
            if (jQuery(this).parsley().validate()) {
                ...
                AjaxCall({
                    _url : "{{ URL::to('school/grade/ajax_save') }}",
                    _data : ajax_data,
                    _is_show_msg : true,
        ...
        function openEditModal(id, model_selector = ".add-edit-model") {
            ...
            ajax_data.append('grade_id', id);
            AjaxCall({
                _url : "{{ URL::to('school/grade/get_data') }}",
                _data : ajax_data,
